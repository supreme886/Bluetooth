...
//    m_localDevice = m_manager->usableAdapter();
    ...
    connect(m_manager,&BluezQt::Manager::deviceAdded,this,&MainWindow::serviceDiscovered);
...
void MainWindow::InitMainbottomUI()
{
...
//    loadLabel->setStyleSheet("background:blue;");
    ...
    connect(m_timer,&QTimer::timeout,this,&MainWindow::Refresh_load_Label_icon);
    m_timer->start();
...
void MainWindow::onClick_Open_Bluetooth(bool ischeck)
{
...
void MainWindow::serviceDiscovered(BluezQt::DevicePtr device)
{
//    qDebug() << device->name();
...
void MainWindow::receiveConnectsignal(BluezQt::DevicePtr device)
{
...
void MainWindow::bluetoothPairError(QBluetoothLocalDevice::Error error)
{
    qDebug() << Q_FUNC_INFO <<error;
}

void MainWindow::pairingDisplayPinCode(QBluetoothAddress address, QString pin)
{
    qDebug() << Q_FUNC_INFO << address.toString() << pin;
}

void MainWindow::pairingDisplayConfirmation(QBluetoothAddress address, QString pin)
{
    qDebug() << Q_FUNC_INFO << address.toString() << pin;
}

void MainWindow::pairingFinished(QBluetoothAddress address, QBluetoothLocalDevice::Pairing pair)
{
    qDebug() << Q_FUNC_INFO << address.toString() << pair;
}

void MainWindow::Refresh_load_Label_icon()
{
    if(i == 0)
        i = 7;
